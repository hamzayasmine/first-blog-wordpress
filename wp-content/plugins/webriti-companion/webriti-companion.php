...
if (!function_exists('webriti_companion_activate')) {
    ...
    function webriti_companion_activate() {
        ...
        if ('Appointment' == $theme->name || 'Appointment Green' == $theme->name || 'Appointment Blue' == $theme->name || 'Appointment Red' == $theme->name || 'vice'== $theme->name || 'Appointment Child' == $theme->name || 'Appointment child' == $theme->name || 'Mandy' == $theme->name || 'Shk Corporate'== $theme->name ) {
        ...
        if ( 'Wallstreet' == $theme->name || 'Bluestreet' == $theme->name || 'Leo' == $theme->name || 'Wallstreet Light' == $theme->name || 'Wallstreet child' == $theme->name || 'Wallstreet Child' == $theme->name){
        ...
        if ( 'Rambo' == $theme->name || 'Spicy' == $theme->name || 'WorkPress' == $theme->name || 'Mambo' == $theme->name || 'Redify' == $theme->name || 'Rambo child' == $theme->name || 'Rambo Child' == $theme->name)
            {
        ...
        if ( 'Busiprof' == $theme->name || 'LazyProf' == $theme->name || 'vdequator' == $theme->name  || 'ARzine' == $theme->name  || 'vdperanto' == $theme->name || 'Busiprof child' == $theme->name || 'Busiprof Child' == $theme->name )
            {
...
} else if ('Appointment' == $theme->name || 'Appointment Green' == $theme->name || 'Appointment Blue' == $theme->name || 'Appointment Red' == $theme->name || 'Appointment Child' == $theme->name || 'Appointment child' == $theme->name || 'Mandy' == $theme->name || 'Shk Corporate' == $theme->name ) {
    register_activation_hook(__FILE__, 'webriti_companion_install_function');
...
} else if('Wallstreet' == $theme->name || 'Bluestreet' == $theme->name || 'Leo' == $theme->name || 'Wallstreet Light' == $theme->name || 'Wallstreet Child' == $theme->name || 'Wallstreet child' == $theme->name){
    register_activation_hook( __FILE__, 'webriti_companion_install_function');
    function webriti_companion_install_function()
    {
...
else if ( 'Busiprof' == $theme->name  || 'LazyProf' == $theme->name  || 'vdequator' == $theme->name   || 'ARzine' == $theme->name  || 'vdperanto' == $theme->name || 'Busiprof child' == $theme->name || 'Busiprof Child' == $theme->name ){

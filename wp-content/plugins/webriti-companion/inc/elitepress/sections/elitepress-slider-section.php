			...
			<div class="flexslider">
			 <div class="flex-viewport">
				...
				<?php 
					...
					<li style="background-image:url(<?php echo esc_url($slide_iteam->image_url); ?>);width: 100%; height: 90vh; background-position: center center; background-size: cover; z-index: 0;">
						<?php
					...
					<?php } 
						...
						$slider_default_title = array(__('Welcome to the ElitePress WordPress Theme','webriti-companion'), __('Boost your site today!','webriti-companion'), __('Let us help you make your website amazing!','webriti-companion'),);
							for($i=1; $i<=3; $i++) 
							{  ?>
							<li style="background-image:url(<?php echo esc_url(WC__PLUGIN_URL.'inc/elitepress/images/slider/'.$i.'.jpg');?>);width: 100%; height: 90vh; background-position: center center; background-size: cover; z-index: 0;">
								...
								<div class="container flex-slider-center">
									...
									<div class="flex-btn-div"><a class="btn1 flex-btn" href="#"><?php esc_html_e('Read More', 'webriti-companion'); ?></a></div>
								</div>
							</li>
					<?php }
					}?>

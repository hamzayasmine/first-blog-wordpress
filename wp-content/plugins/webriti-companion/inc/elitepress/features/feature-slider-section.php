	...
	function elitpress_slider_default_customize_register( $wp_customize ) {
		 ...
		 if(get_option('elitepress_lite_options')!='')
		 {
			$elitepress_slider_content_control = $wp_customize->get_setting( 'elitepress_slider_content' );
				...
				$elitepress_slider_content_control->default = json_encode( array(
				array(
				'title'      => esc_html__( 'ElitePress by webriti themes', 'webriti-companion' ),
				'text'       => esc_html__( 'With our themes, you can create a stunning website in no time.', 'webriti-companion' ),
				...
				array(
				'title'      => esc_html__( 'A clean and fresh design', 'webriti-companion' ),
				'text'       => esc_html__( 'With our themes, you can create a stunning website in no time.', 'webriti-companion' ),
				'button_text'      => esc_html__('Read More','webriti-companion'),
				'link'       => '#',

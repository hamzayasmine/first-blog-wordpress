...
function elitepress_portfolio_customizer( $wp_customize ) {
	...
	array(
        'default'        => esc_html__('Latest projects','webriti-companion'),
        'capability'     => 'edit_theme_options',
	...
	array(
        'default'        => esc_html__('Growing your business','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	array(
        'default'        => esc_html__('Functional elegance','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	array(
        'default'        => esc_html__('Planning your next move','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));

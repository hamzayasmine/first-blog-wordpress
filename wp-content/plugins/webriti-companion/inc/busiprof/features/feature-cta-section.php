...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? true : false;
	...
	$wp_customize->add_control(	'busiprof_theme_options[home_banner_strip_enabled]' , array(
		...
		array( 'default' => esc_html__('Busiprof: the perfect WordPress theme for an app and web developer','webriti-companion') , 'type' => 'option', 'sanitize_callback' => 'busiprof_input_field_sanitize_text' ) );

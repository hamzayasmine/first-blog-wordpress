		...
		{	
			...
			if ( ! empty( $busiprof_service_content_control ) ) {
				$busiprof_service_content_control->default = json_encode( array(
					...
					'title'      => esc_html__( 'Web Design', 'webriti-companion' ),
					'text'       => esc_html__( 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 'webriti-companion' ),
					'link'       => '#',
					'id'         => 'customizer_repeater_56d7ea7f40b56',
					'color'      => '#e91e63',
					),
					...
					'icon_value' => 'fa-tasks',
					'choice'    => 'customizer_repeater_icon',
					'title'      => esc_html__( 'Unique Elements', 'webriti-companion' ),
					'text'       => esc_html__( 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 'webriti-companion' ),
					'link'       => '#',
					'id'         => 'customizer_repeater_56d7ea7f40b66',
					'color'      => '#00bcd4',
					...
					'choice'    => 'customizer_repeater_icon',
					'title'      => esc_html__( 'User Friendly', 'webriti-companion' ),
					'text'       => esc_html__( 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 'webriti-companion' ),
					'link'       => '#',
					'id'         => 'customizer_repeater_56d7ea7f40b86',
					'color'      => '#4caf50',
					...
					'choice'    => 'customizer_repeater_icon',
					'title'      => esc_html__( '24/7 Support', 'webriti-companion' ),
					'text'       => esc_html__( 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 'webriti-companion' ),
					'link'       => '#',
					'id'         => 'customizer_repeater_56d7ea7f40b96',
					'color'      => '#5ca2df',

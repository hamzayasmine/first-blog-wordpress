			...
			<div class="row">
				<div class="col-md-12">
					<div class="section-title">
						...
						<h1 class="section-heading"><?php echo esc_html($current_options['testimonials_title']);?></h1>
				...
				<div class="carousel-inner">
					...
					<div class="col-md-12 pull-left item <?php if($i == 0) { echo 'active'; } ?>">
						...
						<div class="post"> 
							...
							<div class="entry-content">
								<p><?php echo esc_html__('We are a group of passionate designers and developers who really love creating awesome WordPress themes & giving support. Widest laborum dolo rumes fugats untras. Ethar omnis iste natus error sit voluptatem accusantiexplicabo. Nemo enim ipsam eque porro quisquam est, qui dolorem ipsum am quaerat voluptatem...','webriti-companion'); ?></p>
							</div>
							<div class="media"> 
								<div class="media-body">

		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-title">
					...
					<h1 class="section-heading"><?php echo esc_html($current_options['service_heading_one']); ?></h1>
...
function busiprof_service_content( $busiprof_service_content, $is_callback = false ) {
	...
	if ( ! empty( $busiprof_service_content ) ) {
		...
		foreach ( $busiprof_service_content as $features_item ) :
			...
			{
			$colors = array('#e91e63','#00bcd4','#4caf50', '#4caf50');
			$title = array (esc_html__('Web Design','webriti-companion'), esc_html__('Unique Elements','webriti-companion'), esc_html__('User Friendly','webriti-companion'), esc_html__('24/7 Support','webriti-companion'));
			...
			<div class="col-md-3 col-sm-6 col-xs-12 service-box">
				...
				<div class="entry-content">
					<p><?php esc_html_e('It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.','webriti-companion'); ?></p>
				</div>		
				</div>
			</div>
			<?php } 

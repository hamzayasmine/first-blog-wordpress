		...
		'quality_service_default_content', json_encode(
			array(
				array(
					...
					'title'      => esc_html__( 'Highly Customizable1', 'webriti-companion' ),
				...
				array(
					...
					'title'      => esc_html__( 'Responsive Layout', 'webriti-companion' ),
					'text'       => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed dosit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut.', 'webriti-companion' ),
					'link'       => '#',
					'choice'    => 'customizer_repeater_icon',
					'open_new_tab' => 'no',
...
{	
			...
			'service_one_title' => esc_html__('Highly Customizable','webriti-companion'),
			'service_two_title' => esc_html__('Responsive Layout','webriti-companion'),
			'service_three_title' => esc_html__('User Experience','webriti-companion'),
			'service_four_title' => esc_html__('Creative Web Design','webriti-companion'),
			...
			'service_one_read_more' => esc_html__('Read More','webriti-companion'),
			'service_two_read_more' => esc_html__('Read More','webriti-companion'),
			'service_three_read_more' => esc_html__('Read More','webriti-companion'),
			'service_four_read_more' => esc_html__('Read More','webriti-companion'),

...
$current_options = wp_parse_args(  get_option( 'rambo_pro_theme_options', array() ), $rambo_pro_theme_options );
	$quality_portfolio_title    = isset($current_options['project_heading_one'])? $current_options['project_heading_one'] : __('Featured portfolio projects','webriti-companion');
...
{	
	return $theme_options=array(
			...
			'project_one_title' => esc_html__('Mobile Apps','webriti-companion'),
			'project_one_text' => esc_html__('A set of pieces of creative work collected to be shown to potential customers or employers; "the artist had put together a portfolio of his work"','webriti-companion'),

			'project_two_thumb' => WC__PLUGIN_URL.'/inc/rambo/img/port2.jpg',
			'project_two_title' => esc_html__('Super Baby','webriti-companion'),
			'project_two_text' => esc_html__('A set of pieces of creative work collected to be shown to potential customers or employers; "the artist had put together a portfolio of his work"','webriti-companion'),

			'project_three_thumb' => WC__PLUGIN_URL.'/inc/rambo/img/port3.jpg',
			'project_three_title' => esc_html__('Coffee Break','webriti-companion'),
			'project_three_text' => esc_html__('A set of pieces of creative work collected to be shown to potential customers or employers; "the artist had put together a portfolio of his work"','webriti-companion'),

			'project_four_thumb' => WC__PLUGIN_URL.'/inc/rambo/img/port4.jpg',
			'project_four_title' => esc_html__('Beautiful Birds','webriti-companion'),
			'project_four_text' => esc_html__('A set of pieces of creative work collected to be shown to potential customers or employers; "the artist had put together a portfolio of his work"','webriti-companion'),
		);
}
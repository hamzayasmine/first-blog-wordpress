...
if ( ! function_exists( 'webriti_rambo_slider' ) ) :
	...
	function webriti_rambo_slider() {
		...
		{	
			...
			{
				$slider_title = isset($current_options['slider_title'])?   $current_options['slider_title'] : esc_html__('Responsive WP theme','webriti-companion');
			}
		}
		else
		{
		...
		{	
			if(is_numeric ($current_options['slider_post']))
				...
				{
					$slider_text = isset($current_options['slider_text'])?   $current_options['slider_text'] : esc_html__('We are a group of passionate designers and developers who really love creating awesome WordPress themes & giving support.','webriti-companion');
				}
		}
		else
		{
...
<div class="main_slider">
	<div class="carousel-inner">
		...
		<div id="post-<?php the_ID(); ?>" class="item active">
			<div class="item" style="background-image:url(<?php echo $slider_post; ?>); width: 100%; height: 70vh; background-position: center center; background-size: cover; z-index: 0;" >

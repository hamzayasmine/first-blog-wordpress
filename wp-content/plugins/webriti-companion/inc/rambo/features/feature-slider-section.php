...
/* Header Section */
	...
	$slider_post = isset($current_options['slider_post'])? $ImagePath : WC__PLUGIN_URL.'/inc/rambo/img/slider.jpg';
		...
		$slider_title = isset($current_options['slider_title'])?   get_the_title($current_options['slider_title']) : esc_html__('Responsive WP theme','webriti-companion');
		...
		$slider_text = isset($current_options['slider_text'])?   get_post_field('post_content', $current_options['slider_text']) : esc_html__('We are a group of passionate designers and developers who really love creating awesome WordPress themes & giving support.','webriti-companion');

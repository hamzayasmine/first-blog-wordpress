...
//Project panel
	...
	'priority'   => 517,
		...
		// enable project section
			...
			array(
				'default' => esc_html__('Featured Portfolio Projects','webriti-companion'),
				'capability'     => 'edit_theme_options',
		...
		'rambo_pro_theme_options[project_one_title]', array(
			'default'        => esc_html__('Mobile Apps','webriti-companion'),
			'capability'     => 'edit_theme_options',
			'sanitize_callback' => 'rambo_project_sanitize_html',
			'type' => 'option',
		));
		...
		'rambo_pro_theme_options[project_one_text]', array(
			'default'        => esc_html__('A set of pieces of creative work collected to be shown to potential customers or employers the artist had put together a portfolio of his work','webriti-companion'),
			'capability'     => 'edit_theme_options',
		...
		'rambo_pro_theme_options[project_two_title]', array(
			'default'        => esc_html__('Super Baby','webriti-companion'),
			'capability'     => 'edit_theme_options',
			'sanitize_callback' => 'rambo_project_sanitize_html',
			'type' => 'option',
		));
		...
		'rambo_pro_theme_options[project_three_title]', array(
			'default'        => esc_html__('Coffee Break','webriti-companion'),
			'capability'     => 'edit_theme_options',
			'sanitize_callback' => 'rambo_project_sanitize_html',
			'type' => 'option',
		));
